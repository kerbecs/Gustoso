...
CREATE TABLE user(
                     ...
                     CONSTRAINT user_description_fk FOREIGN KEY(user_description) REFERENCES user(id)
);
...
CREATE TABLE produce(
                        id int8 PRIMARY KEY AUTO_INCREMENT,
                        name varchar(40) NOT NULL UNIQUE CHECK(name REGEXP '^[A-Za-z 0-9\s\'\-]{2,25}$'),
...
(
    ...
    CONSTRAINT order_produce_order_fk FOREIGN KEY (order_id) REFERENCES orders (id),
